...
# Pre-download the Whisper model
RUN python3 -c \"from transformers import pipeline; import os; model_id = 'openai/whisper-' + os.getenv('WHISPER_MODEL'); pipeline('automatic-speech-recognition', model=model_id, device='cpu')('/tmp/test.wav')\"
