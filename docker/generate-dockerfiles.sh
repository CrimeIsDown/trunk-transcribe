...
sed -i 's#FROM ubuntu:22.04#FROM nvidia/cuda:12.1.0-base-ubuntu22.04#g' Dockerfile.whisper
...
sed -i 's#FROM ubuntu:22.04#FROM nvidia/cuda:12.1.0-cudnn8-runtime-ubuntu22.04#g' Dockerfile.fasterwhisper
...
sed -i 's#FROM ubuntu:22.04#FROM nvidia/cuda:12.1.0-cudnn8-runtime-ubuntu22.04#g' Dockerfile.whispers2t
